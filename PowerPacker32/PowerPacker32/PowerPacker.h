...
public:
	...
	const char * writeBD(const void *pBuffer, const size_t nBytes)
	{
		std::stringstream s;
		s.write((const char*)pBuffer, (unsigned int)nBytes);
...
struct tBuffer
{
	...
	unsigned char *ptr; // buffer of data
...
protected:
	...
	void LoadBuffer(const unsigned char *pData, const ulong nSize);
...
public:
	...
	/*
	bool UnpackBuffer(const unsigned char *pData, const ulong nSize)
	{
